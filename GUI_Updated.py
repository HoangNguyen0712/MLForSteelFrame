...
# Create the Window
window = sg.Window('Prediction of Seismic Responses of Steel Moment Frames', layout)
...
while True:
    ...
    if event == 'Default':
        ...
        window['-f5-'].update('Optional')
        window['-f6-'].update('Optional')
        window['-f7-'].update('Optional')
